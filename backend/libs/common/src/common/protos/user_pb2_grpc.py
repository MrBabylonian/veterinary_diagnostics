...
import grpc
from common.protos import user_pb2 as protos_dot_user__pb2
...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetUserByEmail = channel.unary_unary(
            ...
            request_serializer=protos_dot_user__pb2.GetUserByEmailRequest.SerializeToString,
            response_deserializer=protos_dot_user__pb2.UserResponse.FromString,
            _registered_method=True,
        )
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        ...
        "GetUserByEmail": grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=protos_dot_user__pb2.GetUserByEmailRequest.FromString,
            response_serializer=protos_dot_user__pb2.UserResponse.SerializeToString,
        ),
...
class UserService(object):
    ...
    def GetUserByEmail(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/user.UserService/GetUserByEmail",
            protos_dot_user__pb2.GetUserByEmailRequest.SerializeToString,
            protos_dot_user__pb2.UserResponse.FromString,
            options,
            channel_credentials,
            insecure,
